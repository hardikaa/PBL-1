    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item">
            ...
            <ul class="first-level {{ request()->is('main/polikia') || request()->is('main/poliumum') || request()->is('main/poliumum') || request()->is('main/rawat-inap') ? 'in' : '' }} collapse"
                ...
                {{-- UGD --}}
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->is('triase') ? 'active' : '' }}"
        ...
        <li class="sidebar-item">
            ...
            <ul class="first-level collapse {{ request()->is('surat-keterangan-sehat*') || request()->is('surat-keterangan-sakit*') || request()->is('/') || request()->is('general-consent*') ? 'show' : '' }}"
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->is('main/general-consent') ? 'active' : '' }}"
                        href="/main/general-consent" aria-expanded="false">
                        <div class="round-16 d-flex align-items-center justify-content-center">
                            <i class="ti ti-circle"></i>
                        </div>
        ...
        {{ request()->is('dokter') || request()->is('layanan') || request()->is('poli') ? 'active' : '' }}"
            ...
            <ul class="first-level {{ request()->is('dokter') || request()->is('layanan') || request()->is('poli') ? 'in' : '' }} collapse"
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link {{ request()->is('layanan') ? 'active' : '' }}"
