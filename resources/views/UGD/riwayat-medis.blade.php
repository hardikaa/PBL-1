...
@section('pageContent')
    ...
    <style>
        /* Perbaiki posisi pagination agar tidak ketumpuk */
        .pagination {
                        ...
                        <tbody class="align-middle text-center">
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->no_rm }}</td>
                                    <td>{{ $item->data_pasien->nama_lengkap ?? '-' }}</td>
                                    <td>
                                        {{ $item->data_pasien && $item->data_pasien->tanggal_lahir
                                            ? \Carbon\Carbon::parse($item->data_pasien->tanggal_lahir)->format('d-m-Y')
                                            : '-' }}
                                    </td>
                                    <td>{{ $item->data_pasien->nomor_telepon ?? '-' }}</td>
